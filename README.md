...
<img width="260px" align="right" hspace="10" vspace="5" src="https://github.com/jimijings11/cordova-plugin-email-composer/blob/example/images/ios_iphone5s_spacegrey_portrait.png">
...
Execute from the projects root folder:
    ...
    $ cordova plugin add https://github.com/jimijings11/cordova-plugin-email-composer.git
